...
class Franchise:
  ...
  def __repr__(self):
    return "Our address is " + self.address
...
early_birds = Menu("Early birds", early_birds_items, 1500, 1800)
...
print(early_birds.calculate_bill(['salumeria plate', 'mushroom ravioli (vegan)']))

flagship_store = Franchise("1232 West End Road", [brunch, early_birds, dinner, kids])

new_installment = Franchise("12 East Mulberry Street", [brunch, early_birds, dinner, kids])

arepas_place = Franchise("189 Fitzgerald Avenue", arepa)

print(flagship_store.available_menus(1700))

basta = Business("Basta Fazoolin' with my Heart", [new_installment, flagship_store])
